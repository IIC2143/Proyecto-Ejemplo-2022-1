...
RSpec.describe Publication, type: :request do
    ...
    let!(:attr_publication){ {:title => Faker::Lorem.words(number:20), :content => Faker::Lorem.paragraph}}
    ...
    describe "create" do
        # La idea es que cuando yo cree una publicación la cuenta de usuario totales se incremente en 1
    ...
    describe "update" do
        it "shouldn't change a Publication" do
            expect{
